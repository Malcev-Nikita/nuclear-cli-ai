...
позавчера?», «какая погода» → «а в Питере?». Короткую фразу с «а»/«и» ассистент
принимает **без имени** несколько секунд после своего ответа; дальше уточнение
уходит тому навыку, который отвечал последним (он помнит контекст 3 минуты).
