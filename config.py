...
# Перебивание голосом: пока ассистент говорит, он слушает микрофон и замолкает,
# если вы заговорили поверх него. Число — во сколько раз ваш голос должен быть
# громче эха его собственного голоса из колонок. Меньше = легче перебить,
# но любой громкий звук (хлопок двери) тоже заткнёт его. 0 = выключить.
BARGE_GAIN = 3.0
